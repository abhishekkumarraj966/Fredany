...
const PopupAlbum = ({ setIsPopupOpen, imsg, setImage }) => {
  ...
  return (
    <div className="h-screen w-[350px] lg:w-[900px] sm:mt-[3%] mt-[12%] sm:w-[700px] bg-[#1f1c147c] fixed top-0 flex justify-center items-center z-10 ml-[-11%] lg:mx-40 sm:mx-0 ">
      <div
